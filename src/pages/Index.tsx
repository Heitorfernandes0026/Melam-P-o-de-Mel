  ...
  <section className="relative min-h-[100svh] flex items-center justify-center overflow-hidden">
    ...
    <div className="container mx-auto px-5 md:px-6 relative z-10 pt-16 md:pt-20 pb-8">
      ...
      >
        ...
        >
          <div className="bg-white/60 rounded-2xl md:rounded-3xl p-4 md:p-6"
            style={{
              maskImage: 'radial-gradient(ellipse 85% 85% at center, black 40%, transparent 90%)',
              WebkitMaskImage: 'radial-gradient(ellipse 85% 85% at center, black 40%, transparent 90%)',
            }}
          >
            <img
              src={logoMelamo}
